...
class IndexTable extends Component
{
    ...
    public function updateMissing(int $languageId): void
    {
        try {
            ...
            report($exception);
            $this->setError(__('Unable to update translations. Please check language file permissions and try again.'));
    ...
    public function autoTranslate(int $languageId): void
    {
        try {
            ...
            report($exception);
            $this->setError(__('Unable to auto translate this language. Please check the translation provider and try again.'));
