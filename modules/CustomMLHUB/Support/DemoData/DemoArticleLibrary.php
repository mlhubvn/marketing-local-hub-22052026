...
class DemoArticleLibrary
{
    ...
    {
        return [
            'MLHUB giúp hộ kinh doanh địa phương tăng trưởng như thế nào',
            ...
            'Vì sao MLHUB dùng dữ liệu hành vi thay vì đoán mò',
            ...
            'Mô hình partner quản lý nhiều cơ sở bằng MLHUB',
            ...
            'Những chỉ số nhà đầu tư nên nhìn trong demo MLHUB',
            ...
            'Checklist trước khi trình bày dashboard MLHUB',
    ...
    public static function excerpt(string $title, int $index): string
    {
        $angles = [
            ...
            'Góc nhìn từ MLHUB về cách biến hoạt động hằng ngày thành dữ liệu và doanh thu.',
        ];
    ...
    public static function article(string $title, int $index): string
    {
        ...
        $blocks[] = '<p>Tại MLHUB, chúng tôi tin rằng một hộ kinh doanh tại Đà Nẵng dù nhỏ vẫn có thể vận hành bài bản như doanh nghiệp lớn, '
        ...
        $blocks[] = '<ul>'
            .'<li>Bước 1: Khai báo cơ sở và ngành nghề để MLHUB gợi ý đúng loại chiến dịch.</li>'
        ...
        $blocks[] = '<p>'.self::conclusion($theme).' MLHUB đóng vai trò là bộ tăng trưởng số gọn nhẹ: gom dữ liệu khách hàng, '
    ...
    {
        return [
            ['q' => 'MLHUB là gì?', 'a' => 'MLHUB là bộ tăng trưởng số dành cho hộ kinh doanh và cơ sở địa phương, giúp gom mã QR, đánh giá thật, ưu đãi, dữ liệu khách hàng và CRM về một nền tảng duy nhất.'],
            ['q' => 'MLHUB phù hợp với ai?', 'a' => 'MLHUB phù hợp với quán cà phê, nhà hàng, spa, salon, homestay, cửa hàng đặc sản, phòng khám và các hộ kinh doanh muốn tăng trưởng bằng dữ liệu thay vì cảm tính.'],
            ['q' => 'MLHUB có phải phần mềm bán hàng hay POS không?', 'a' => 'Không. MLHUB tập trung vào tăng trưởng và chăm sóc khách hàng: thu dữ liệu qua QR, xin đánh giá, phát ưu đãi và quản lý quan hệ khách hàng, chứ không thay thế phần mềm bán hàng.'],
            ['q' => 'MLHUB khác gì so với chạy quảng cáo?', 'a' => 'Quảng cáo giúp kéo khách mới đến một lần, còn MLHUB giúp giữ dữ liệu khách hàng và chăm sóc để họ quay lại nhiều lần, biến chi phí một lần thành tài sản lâu dài.'],
            ['q' => 'MLHUB có dùng được cho hộ kinh doanh nhỏ không?', 'a' => 'Có. MLHUB được thiết kế gọn nhẹ, có gói miễn phí để hộ kinh doanh nhỏ bắt đầu mà không cần kiến thức kỹ thuật.'],
            ...
            ['q' => 'Cần nhập thông tin gì khi tạo cơ sở?', 'a' => 'Bạn cần nhập tên cơ sở, ngành nghề, địa chỉ, số điện thoại và giờ mở cửa. Thông tin này giúp MLHUB gợi ý đúng loại chiến dịch.'],
            ...
            ['q' => 'Ngành nghề dùng để làm gì?', 'a' => 'Ngành nghề giúp MLHUB đưa ra gợi ý chiến dịch, mẫu landing page và nội dung phù hợp với đặc thù kinh doanh của bạn.'],
            ...
            ['q' => 'MLHUB có tự gợi ý chiến dịch theo ngành không?', 'a' => 'Có. Dựa trên ngành nghề bạn khai báo, MLHUB gợi ý các loại chiến dịch QR, ưu đãi và landing page phù hợp.'],
            ['q' => 'QR trong MLHUB dùng để làm gì?', 'a' => 'Mã QR dùng để xin đánh giá, phát ưu đãi, thu khách tiềm năng, nhận đặt lịch và thu phản hồi ngay tại điểm bán.'],
            ...
            ['q' => 'Có thể theo dõi lượt quét QR không?', 'a' => 'Có. MLHUB ghi nhận từng lượt quét kèm thời gian, thiết bị và khu vực để bạn biết chiến dịch nào hiệu quả.'],
            ...
            ['q' => 'MLHUB có tạo review ảo không?', 'a' => 'Không. MLHUB chỉ giúp thu đánh giá thật từ khách hàng thật; chúng tôi không tạo và không khuyến khích review ảo.'],
            ...
            ['q' => 'Có thể chuyển khách hài lòng sang Google Review không?', 'a' => 'Có. Sau khi khách thể hiện hài lòng, MLHUB có thể hướng họ tới trang Google Review của cơ sở.'],
            ...
            ['q' => 'CRM trong MLHUB có khó dùng không?', 'a' => 'Không. CRM được thiết kế đơn giản cho chủ hộ kinh doanh: xem khách, gắn thẻ, ghi chú và lên lịch chăm sóc một cách trực quan.'],
            ...
            ['q' => 'MLHUB có tự động gửi email không?', 'a' => 'Có. Bạn có thể thiết lập automation gửi email cảm ơn, nhắc lịch hoặc chăm sóc sau dịch vụ theo điều kiện.'],
            ...
            ['q' => 'WhatsApp và Zalo có được tích hợp không?', 'a' => 'MLHUB hỗ trợ kênh nhắn tin để chăm sóc khách; trong bản demo các kênh này là mô phỏng, không gửi tin thật.'],
            ...
            ['q' => 'MLHUB có kết nối Google Business không?', 'a' => 'Có. Bạn có thể kết nối hồ sơ Google Business để quản lý đánh giá và bài đăng tập trung.'],
            ...
            ['q' => 'MLHUB có giúp quản lý review Google không?', 'a' => 'Có. Bạn xem, phản hồi và theo dõi đánh giá Google ngay trong MLHUB.'],
            ...
            ['q' => 'Có nên mua review Google không?', 'a' => 'Không nên. Review ảo vi phạm chính sách và làm mất niềm tin; MLHUB hướng tới đánh giá thật bền vững.'],
            ...
            ['q' => 'MLHUB có phù hợp với thị trường Đà Nẵng không?', 'a' => 'Rất phù hợp. MLHUB được xây dựng với ngữ cảnh hộ kinh doanh Đà Nẵng - Quảng Nam: du lịch, ẩm thực, dịch vụ địa phương.'],
            ['q' => 'Những ngành nào nên dùng MLHUB trước?', 'a' => 'Ẩm thực, làm đẹp, lưu trú và dịch vụ có khách quay lại thường thấy hiệu quả sớm nhất.'],
            ['q' => 'Spa, cà phê, homestay dùng MLHUB như thế nào?', 'a' => 'Họ dùng QR để xin đánh giá và phát ưu đãi, dùng CRM để chăm sóc khách quay lại và đo hiệu quả qua dashboard.'],
            ['q' => 'OCOP và đặc sản có dùng được MLHUB không?', 'a' => 'Có. Cửa hàng đặc sản, OCOP dùng landing page và form thu đơn, kết hợp ưu đãi mùa vụ để tăng doanh thu.'],
            ['q' => 'MLHUB có phù hợp cho đối tác triển khai nhiều hộ kinh doanh không?', 'a' => 'Có. Gói Partner cho phép quản lý số lượng lớn cơ sở và chiến dịch, phù hợp với đối tác triển khai.'],
            ...
            ['q' => 'Blog demo trong MLHUB dùng để làm gì?', 'a' => 'Blog demo minh họa khả năng nội dung của hệ thống và cung cấp kiến thức tăng trưởng cho chủ hộ kinh doanh.'],
            ...
            ['q' => 'AI trong MLHUB có thay chủ kinh doanh quyết định không?', 'a' => 'Không. AI chỉ hỗ trợ gợi ý nội dung và phản hồi; quyết định cuối cùng luôn thuộc về chủ hộ kinh doanh.'],
        ];
    }
    ...
    private static function sections(string $theme, int $index): array
    {
        ...
        $byTheme = match ($theme) {
            ...
            'qr' => [
                ...
                'Mỗi lượt quét là một điểm dữ liệu' => 'MLHUB ghi lại thời gian, thiết bị và khu vực của mỗi lượt quét. '
            ...
            'industry' => [
                'Điều chỉnh theo đặc thù ngành' => 'Spa và salon cần đặt lịch và nhắc hẹn; quán cà phê cần ưu đãi quay lại; homestay cần thu khách tiềm năng và đánh giá; '
                    .'cửa hàng đặc sản cần landing page và đơn hàng. MLHUB gợi ý đúng loại chiến dịch cho từng ngành.',
