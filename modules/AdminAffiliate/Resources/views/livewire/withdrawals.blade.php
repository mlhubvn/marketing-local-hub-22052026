@php
    $metricCards = [
        ...
        ['label' => __('Approved Value'), 'value' => format_money($summary['approved']), 'description' => __('Total amount already approved for payout.'), 'icon' => 'fa-light fa-circle-check', 'tone' => 'rgb(5 150 105)', 'progress' => $summary['approved'] > 0 ? 100 : 0],
    ];
    $statusLabels = [
        'all' => __('All'),
        '0' => __('Pending'),
