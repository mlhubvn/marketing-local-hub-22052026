                ...
                @foreach ($dailyScans as $day)
                    <div class="flex min-w-0 flex-1 flex-col items-center gap-2">
                        <div class="flex h-48 w-full items-end rounded-t-xl" style="background-color: rgba(var(--theme-border-color-rgb), .20);">
                            <div class="w-full rounded-t-xl" style="height: {{ max(4, (int) round(($day['total'] / $maxDailyScans) * 100)) }}%; background: linear-gradient(180deg, var(--theme-accent), var(--theme-warning-color));"></div>
                        </div>
