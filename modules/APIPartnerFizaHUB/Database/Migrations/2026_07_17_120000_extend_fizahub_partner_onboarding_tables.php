...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('partner_onboarding_requests', function (Blueprint $table): void {
            ...
            $table->index(['partner_code', 'requested_package_code'], 'partner_onboarding_requested_package_index');
            $table->index(['partner_code', 'assigned_consultant_id'], 'partner_onboarding_consultant_index');
        });
