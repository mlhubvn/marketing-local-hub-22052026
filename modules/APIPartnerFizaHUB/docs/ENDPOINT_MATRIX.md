...
4. `partner_token` demo yếu (`fizahub`) công khai trong `.env.example`/help-test: **KHÔNG tự rotate** (cần duyệt + đổi trên Coolify) — xem khuyến nghị chi tiết ở báo cáo cuối mục IX/bảo mật.
