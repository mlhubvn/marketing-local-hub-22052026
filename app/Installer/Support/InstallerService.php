...
class InstallerService
{
    ...
    protected function storeOptions(array $data, ?array $verifiedPurchase): void
    {
        ...
        $this->optionStore->set('website_logo_brand_dark', 'public/img/logo-brand-dark.png');
        $this->optionStore->set('website_logo_brand_light', 'public/img/logo-brand-light.png');
        ...
        $this->optionStore->set('theme_settings.app.default', $this->defaultBackendThemeSettings());
    ...
    protected function defaultBackendThemeSettings(): array
    {
        return [
            'accent_color' => '#0f766e',
    ...
    protected function defaultGuestThemeSettings(): array
    {
        return [
