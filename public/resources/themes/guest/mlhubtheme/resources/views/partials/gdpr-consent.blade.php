...
>
    <div class="localboost-cookie-banner mx-auto max-w-5xl rounded-[1.1rem] border p-4 shadow-[0_24px_80px_-56px_rgba(45,24,16,0.45)] backdrop-blur-xl sm:p-5" style="border-color: #ffe5dc; background: linear-gradient(135deg, rgba(255,95,95,0.06), rgba(255,255,255,0.96) 42%, rgba(255,251,248,0.98));">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex shrink-0 flex-col gap-2 sm:flex-row">
                <button type="button" x-on:click="decline()" class="localboost-cookie-decline inline-flex h-11 items-center justify-center rounded-[var(--theme-button-radius)] border px-4 text-sm font-bold transition hover:-translate-y-px" style="border-color: #ffe5dc; color: #2d1810; background-color: rgba(255,255,255,0.78);">
                    {{ __('Decline') }}
                </button>
                <button type="button" x-on:click="accept()" class="localboost-cookie-accept inline-flex h-11 items-center justify-center rounded-[var(--theme-button-radius)] border px-4 text-sm font-bold text-white shadow-[0_16px_30px_-18px_rgba(255,95,95,0.62)] transition hover:-translate-y-px" style="border-color: #ff8c42; background: linear-gradient(135deg, #ff5f5f 0%, #ff8c42 100%);">
                    {{ __('Allow') }}
                </button>
            </div>
        </div>
