            ...
            <div class="container mx-auto">
                <div class="flex flex-wrap items-center -mx-4">
                    <div class="w-full md:w-1/2 px-4 mb-8 md:mb-0">
                        ...
                        <a class="flex items-center font-medium text-[#ff5f5f] hover:text-[#ff5f5f]" href="{{ url("privacy-policy") }}">
                    ...
                    <div class="w-full md:w-1/2 px-4">
                        <div class="flex flex-wrap justify-end">
                            ...
                            <div class="w-full md:w-auto py-1 md:py-0"><a class="inline-block py-3 px-5 w-full leading-5 text-white bg-[#ff5f5f] hover:bg-[#ff5f5f] font-medium text-center focus:ring-2 focus:ring-[#ffb87a] focus:ring-opacity-50 border border-transparent rounded-md shadow-sm btn-accept" href="javascript:void(0);">{{ __("Allow") }}</a></div>
                        </div>
                    </div>
                </div>
            </div>
