...
@section('content')
    ...
    <style>
        ...
        .lb-feature-hero {
            min-height: 100%;
            background:
                linear-gradient(145deg, rgba(255, 95, 95, .08), rgba(184, 218, 22, .16)),
                #fffefb;
        }
        ...
        .lb-proof-visual {
            background: linear-gradient(145deg, rgba(255, 95, 95, .08), rgba(184, 218, 22, .16));
        }
        ...
        .lb-final-preview {
            background: linear-gradient(145deg, rgba(255, 95, 95, .08), rgba(184, 218, 22, .18));
        }
