...
return new class extends Migration
{
    ...
    {        // Source: database\migrations\2026_04_18_110000_create_database.php
        (function (): void {
                    // Source: database\migrations\2026_04_18_110000_create_database.php
                    (static function (): void {
                        ...
                        try {
                            ...
                            Schema::table('team_activity_logs', function (Blueprint $table): void {
                                $table->foreign('actor_user_id', 'team_activity_logs_actor_user_id_foreign')->references('id')->on('users')->nullOnDelete();
                                $table->foreign('owner_user_id', 'team_activity_logs_owner_user_id_foreign')->references('id')->on('users')->nullOnDelete();
                                $table->foreign('team_id', 'team_activity_logs_team_id_foreign')->references('id')->on('teams')->nullOnDelete();
                            });
        ...
        // Source: modules\AppBusinessProfiles\Database\Migrations\2026_05_09_210000_create_lb_businesses_table.php
        (function (): void {
        ...
        // Source: modules\AppQRCampaigns\Database\Migrations\2026_05_09_211000_create_lb_campaigns_and_scans_tables.php
        (function (): void {
                    ...
                    Schema::create('lb_qr_scans', function (Blueprint $table): void {
                        $table->id();
                        $table->foreignId('user_id')->constrained('users')->cascadeOnDelete();
                        $table->foreignId('campaign_id')->constrained('lb_campaigns')->cascadeOnDelete();
                        $table->string('ip_address', 45)->nullable();
                        $table->text('user_agent')->nullable();
        ...
        // Source: modules\AppReviewBooster\Database\Migrations\2026_05_09_212000_create_lb_review_feedbacks_table.php
        (function (): void {
                    Schema::create('lb_review_feedbacks', function (Blueprint $table): void {
                        ...
                        $table->text('message')->nullable();
                        $table->timestamps();
                        $table->index(['campaign_id', 'rating']);
                    });
                
        })->call($this);

        // Source: modules\AppBookingPages\Database\Migrations\2026_05_09_213000_create_lb_booking_tables.php
        (function (): void {
                    ...
                    Schema::create('lb_bookings', function (Blueprint $table): void {
                        ...
                        $table->foreignId('service_id')->nullable()->constrained('lb_booking_services')->nullOnDelete();
        ...
        // Source: modules\AppCouponCampaigns\Database\Migrations\2026_05_09_214000_create_lb_coupon_redemptions_table.php
        (function (): void {
        ...
        // Source: modules\AppBusinessLocations\Database\Migrations\2026_05_09_215000_create_lb_locations_table.php
        (function (): void {
        ...
        // Source: modules\AppCustomers\Database\Migrations\2026_05_09_220000_create_lb_customers_table.php
        (function (): void {
        ...
        // Source: modules\AppFeedbackForms\Database\Migrations\2026_05_09_221000_create_lb_feedback_responses_table.php
        (function (): void {
        ...
        // Source: modules\AppLeadForms\Database\Migrations\2026_05_09_222000_create_lb_lead_submissions_table.php
        (function (): void {
        ...
        // Source: modules\AppLandingPages\Database\Migrations\2026_05_09_223000_create_lb_landing_pages_table.php
        (function (): void {
        ...
        // Source: modules\AppMarketingTemplates\Database\Migrations\2026_05_09_224000_create_lb_marketing_templates_table.php
        (function (): void {
                    Schema::create('lb_marketing_templates', function (Blueprint $table): void {
                        $table->id();
                        ...
                        $table->string('type', 60)->default('landing_page');
                        $table->string('category', 60)->default('general')->index();
                        $table->string('goal', 60)->default('lead')->index();
                        $table->text('description')->nullable();
                        $table->string('icon')->default('fa-light fa-grid-2');
                        $table->string('preview_image')->nullable();
                        $table->json('content')->nullable();
                        $table->boolean('is_system')->default(false);
                        $table->string('source', 30)->default('custom')->index();
                        $table->string('visibility', 30)->default('private')->index();
                        $table->string('marketplace_status', 30)->default('none')->index();
                        $table->timestamp('submitted_at')->nullable();
                        $table->timestamp('approved_at')->nullable();
        ...
        // Source: modules\AppReviewBooster\Database\Migrations\2026_05_10_000000_add_reply_status_to_lb_review_feedbacks_table.php
        (function (): void {
                    Schema::table('lb_review_feedbacks', function (Blueprint $table): void {
                        if (! Schema::hasColumn('lb_review_feedbacks', 'status')) {
                            $table->string('status', 24)->default('new')->after('message')->index();
                        }
            
                        if (! Schema::hasColumn('lb_review_feedbacks', 'ai_reply_history_id')) {
                            $table->foreignId('ai_reply_history_id')->nullable()->after('status')->constrained('ai_prompt_histories')->nullOnDelete();
                        }
            
                        if (! Schema::hasColumn('lb_review_feedbacks', 'replied_at')) {
                            $table->timestamp('replied_at')->nullable()->after('ai_reply_history_id');
                        }
        ...
        // Source: modules\AppLandingPages\Database\Migrations\2026_05_10_010000_extend_lb_landing_pages_for_campaign_pages.php
        (function (): void {
                    if (! Schema::hasTable('lb_landing_pages')) {
                        return;
                    }
            
                    Schema::table('lb_landing_pages', function (Blueprint $table): void {
                        if (! Schema::hasColumn('lb_landing_pages', 'campaign_id')) {
                            $table->foreignId('campaign_id')->nullable()->after('business_id')->constrained('lb_campaigns')->nullOnDelete();
                        }
            
                        if (! Schema::hasColumn('lb_landing_pages', 'type')) {
                            $table->string('type', 40)->default('lead')->after('title');
                        }
            
                        if (! Schema::hasColumn('lb_landing_pages', 'template')) {
                            $table->string('template', 80)->default('local_campaign')->after('type');
                        }
            
                        if (! Schema::hasColumn('lb_landing_pages', 'settings')) {
                            $table->json('settings')->nullable()->after('content');
                        }
            
                        if (! Schema::hasColumn('lb_landing_pages', 'visits_count')) {
                            $table->unsignedInteger('visits_count')->default(0)->after('settings');
                        }
            
                        if (! Schema::hasColumn('lb_landing_pages', 'conversions_count')) {
                            $table->unsignedInteger('conversions_count')->default(0)->after('visits_count');
                        }
                    });
                
        })->call($this);

        // Source: modules\AppFeedbackForms\Database\Migrations\2026_05_10_020000_add_status_to_lb_feedback_responses_table.php
        (function (): void {
                    if (! Schema::hasTable('lb_feedback_responses')) {
                        return;
                    }
            
                    Schema::table('lb_feedback_responses', function (Blueprint $table): void {
                        if (! Schema::hasColumn('lb_feedback_responses', 'status')) {
                            $table->string('status', 30)->default('new')->after('message');
                        }
            
                        if (! Schema::hasColumn('lb_feedback_responses', 'resolved_at')) {
        ...
        // Source: modules\AppMarketingTemplates\Database\Migrations\2026_05_10_120000_extend_lb_marketing_templates_for_template_engine.php
        (function (): void {
                    Schema::table('lb_marketing_templates', function (Blueprint $table): void {
                        if (! Schema::hasColumn('lb_marketing_templates', 'team_id')) {
                            $table->foreignId('team_id')->nullable()->after('user_id')->constrained('teams')->nullOnDelete();
                        }
            
                        if (! Schema::hasColumn('lb_marketing_templates', 'created_by')) {
                            $table->foreignId('created_by')->nullable()->after('team_id')->constrained('users')->nullOnDelete();
                        }
            
                        if (! Schema::hasColumn('lb_marketing_templates', 'slug')) {
                            $table->string('slug')->nullable()->after('name')->index();
                        }
            
                        if (! Schema::hasColumn('lb_marketing_templates', 'category')) {
                            $table->string('category', 60)->default('general')->after('type')->index();
                        }
            
                        if (! Schema::hasColumn('lb_marketing_templates', 'goal')) {
                            $table->string('goal', 60)->default('lead')->after('category')->index();
                        }
            
                        if (! Schema::hasColumn('lb_marketing_templates', 'description')) {
                            $table->text('description')->nullable()->after('goal');
                        }
            
                        if (! Schema::hasColumn('lb_marketing_templates', 'icon')) {
                            $table->string('icon')->default('fa-light fa-grid-2')->after('description');
                        }
            
                        if (! Schema::hasColumn('lb_marketing_templates', 'status')) {
                            $table->string('status', 30)->default('active')->after('is_system')->index();
                        }
            
                        if (! Schema::hasColumn('lb_marketing_templates', 'usage_count')) {
                            $table->unsignedInteger('usage_count')->default(0)->after('status');
                        }
            
                        if (! Schema::hasColumn('lb_marketing_templates', 'settings')) {
                            $table->json('settings')->nullable()->after('usage_count');
                        }
                    });
                
        })->call($this);

        // Source: database\migrations\2026_05_10_230000_backfill_localboost_template_plan_limits.php
        (function (): void {
                    DB::table('plans')
                        ...
                        ->each(function (object $plan): void {
                            ...
                            if (! is_array($permissions) || array_key_exists('max_templates', $permissions)) {
                                return;
                            }
            
                            if (! $this->truthy($permissions['localboost'] ?? false)) {
                                return;
                            }
            
                            $permissions['max_templates'] = $this->defaultTemplateLimit($plan, $permissions);
        ...
        // Source: modules\AppBookingPages\Database\Migrations\2026_05_11_000001_add_availability_to_lb_booking_services.php
        (function (): void {
                    Schema::table('lb_booking_services', function (Blueprint $table): void {
                        if (! Schema::hasColumn('lb_booking_services', 'use_business_hours')) {
                            $table->boolean('use_business_hours')->default(true)->after('time_slots');
                        }
            
                        if (! Schema::hasColumn('lb_booking_services', 'slot_interval')) {
                            $table->unsignedSmallInteger('slot_interval')->default(30)->after('use_business_hours');
                        }
            
                        if (! Schema::hasColumn('lb_booking_services', 'buffer_before')) {
                            $table->unsignedSmallInteger('buffer_before')->default(0)->after('slot_interval');
                        }
            
                        if (! Schema::hasColumn('lb_booking_services', 'buffer_after')) {
                            $table->unsignedSmallInteger('buffer_after')->default(0)->after('buffer_before');
                        }
            
                        if (! Schema::hasColumn('lb_booking_services', 'service_hours')) {
                            $table->json('service_hours')->nullable()->after('buffer_after');
                        }
                    });
                
        })->call($this);

        // Source: modules\AppCustomDomain\database\migrations\2026_05_11_010000_create_custom_domains_table.php
        (function (): void {
        ...
        // Source: modules\AppCustomDomain\database\migrations\2026_05_11_010100_add_custom_domain_permissions_to_plans.php
        (function (): void {
                    ...
                    $defaults = [
                        'starter' => ['qr_custom_domains' => false, 'max_custom_domains' => 0],
                        'growth' => ['qr_custom_domains' => true, 'max_custom_domains' => 3],
                        'agency' => ['qr_custom_domains' => true, 'max_custom_domains' => -1],
                    ];
            
                    DB::table('plans')->orderBy('id')->get(['id', 'slug', 'permissions'])->each(function (object $plan) use ($defaults): void {
                        $permissions = json_decode((string) $plan->permissions, true);
                        ...
                        $tier = collect(array_keys($defaults))->first(fn (string $key): bool => str_contains((string) $plan->slug, $key));
                        $values = $defaults[$tier ?: 'starter'];
        ...
        // Source: modules\AppBusinessLocations\Database\Migrations\2026_05_11_030000_add_qr_design_to_lb_locations_table.php
        (function (): void {
                    Schema::table('lb_locations', function (Blueprint $table): void {
                        if (! Schema::hasColumn('lb_locations', 'qr_design')) {
                            $table->json('qr_design')->nullable()->after('opening_hours');
                        }
                    });
                
        })->call($this);

        // Source: modules\AppBusinessProfiles\Database\Migrations\2026_05_11_040000_add_qr_design_to_lb_businesses_table.php
        (function (): void {
                    Schema::table('lb_businesses', function (Blueprint $table): void {
                        if (! Schema::hasColumn('lb_businesses', 'qr_design')) {
                            $table->json('qr_design')->nullable()->after('opening_hours');
                        }
                    });
    ...
    {        // Source: modules\AppBusinessProfiles\Database\Migrations\2026_05_11_040000_add_qr_design_to_lb_businesses_table.php
        ...
        (function (): void {
                    ...
                    DB::table('plans')->orderBy('id')->get(['id', 'permissions'])->each(function (object $plan): void {
                        $permissions = json_decode((string) $plan->permissions, true);
                        ...
                        unset($permissions['qr_custom_domains'], $permissions['max_custom_domains']);
        ...
        (function (): void {
                    Schema::table('lb_booking_services', function (Blueprint $table): void {
                        foreach (['use_business_hours', 'slot_interval', 'buffer_before', 'buffer_after', 'service_hours'] as $column) {
                            if (Schema::hasColumn('lb_booking_services', $column)) {
        ...
        (function (): void {
                    DB::table('plans')
                        ...
                        ->each(function (object $plan): void {
                            ...
                            unset($permissions['max_templates']);
        ...
        (function (): void {
                    Schema::table('lb_marketing_templates', function (Blueprint $table): void {
                        foreach (['settings', 'usage_count', 'status', 'icon', 'description', 'goal', 'category', 'slug', 'created_by', 'team_id'] as $column) {
        ...
        (function (): void {
                    ...
                    Schema::table('lb_feedback_responses', function (Blueprint $table): void {
                        foreach (['resolved_at', 'status'] as $column) {
                            if (Schema::hasColumn('lb_feedback_responses', $column)) {
                                $table->dropColumn($column);
                            }
                        }
                    });
        ...
        (function (): void {
                    ...
                    Schema::table('lb_landing_pages', function (Blueprint $table): void {
                        ...
                        foreach (['campaign_id', 'type', 'template', 'settings', 'visits_count', 'conversions_count'] as $column) {
                            if (Schema::hasColumn('lb_landing_pages', $column)) {
                                $table->dropColumn($column);
                            }
                        }
                    });
        ...
        (function (): void {
                    Schema::table('lb_review_feedbacks', function (Blueprint $table): void {
                        if (Schema::hasColumn('lb_review_feedbacks', 'ai_reply_history_id')) {
                            $table->dropConstrainedForeignId('ai_reply_history_id');
                        }
            
                        foreach (['resolved_at', 'replied_at', 'status'] as $column) {
                            if (Schema::hasColumn('lb_review_feedbacks', $column)) {
                                $table->dropColumn($column);
                            }
                        }
                    });
        ...
        // Source: modules\AppMarketingTemplates\Database\Migrations\2026_05_09_224000_create_lb_marketing_templates_table.php
        (function (): void {
                    Schema::dropIfExists('lb_marketing_templates');
        ...
        // Source: modules\AppBusinessLocations\Database\Migrations\2026_05_09_215000_create_lb_locations_table.php
        (function (): void {
                    Schema::dropIfExists('lb_locations');
    ...
    protected function defaultTemplateLimit(object $plan, array $permissions): int
    {
        $text = strtolower(trim((string) $plan->slug.' '.$plan->name));
        ...
        $campaignLimit = (int) ($permissions['max_campaigns'] ?? 10);

        return $campaignLimit < 0 ? -1 : max(10, $campaignLimit);
    }
