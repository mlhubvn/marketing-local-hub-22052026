...
class PlanSeeder extends Seeder
{
    ...
    protected function plans(): array
    {
        return [
            ...
            $this->plan('MLHUB Starter Monthly', 'mlhub-starter-monthly', 4, 1, false, false, false, 7, 10, 'Essential MLHUB tools for household businesses starting local digital marketing.', $this->starterPermissions(300)),
            $this->plan('MLHUB Starter Yearly', 'mlhub-starter-yearly', 40, 2, false, false, false, 14, 11, 'Essential MLHUB tools for household businesses starting local digital marketing.', $this->starterPermissions(3600)),
            $this->plan('MLHUB Starter Lifetime', 'mlhub-starter-lifetime', 99, 3, false, false, false, 0, 12, 'Essential MLHUB tools for household businesses starting local digital marketing.', $this->starterPermissions(300)),
            $this->plan('MLHUB Growth Monthly', 'mlhub-growth-monthly', 9, 1, true, false, false, 10, 20, 'Growth tools, automation, and higher limits for expanding local businesses.', $this->growthPermissions(1000)),
            $this->plan('MLHUB Growth Yearly', 'mlhub-growth-yearly', 90, 2, false, false, false, 21, 21, 'Growth tools, automation, and higher limits for expanding local businesses.', $this->growthPermissions(12000)),
            $this->plan('MLHUB Growth Lifetime', 'mlhub-growth-lifetime', 249, 3, false, false, false, 0, 22, 'Growth tools, automation, and higher limits for expanding local businesses.', $this->growthPermissions(1000)),
            $this->plan('MLHUB Pro Monthly', 'mlhub-pro-monthly', 29, 1, true, false, false, 14, 30, 'Advanced automation, AI, CRM, and branding controls for professional teams.', $this->proPermissions(5000)),
            $this->plan('MLHUB Pro Yearly', 'mlhub-pro-yearly', 290, 2, false, false, false, 30, 31, 'Advanced automation, AI, CRM, and branding controls for professional teams.', $this->proPermissions(60000)),
            $this->plan('MLHUB Pro Lifetime', 'mlhub-pro-lifetime', 799, 3, false, false, false, 0, 32, 'Advanced automation, AI, CRM, and branding controls for professional teams.', $this->proPermissions(5000)),
            $this->plan('MLHUB Partner Monthly', 'mlhub-partner-monthly', 99, 1, false, false, false, 14, 40, 'High-capacity MLHUB operations for partners managing many businesses and customers.', $this->partnerPermissions(20000)),
            $this->plan('MLHUB Partner Yearly', 'mlhub-partner-yearly', 990, 2, false, false, false, 30, 41, 'High-capacity MLHUB operations for partners managing many businesses and customers.', $this->partnerPermissions(240000)),
            $this->plan('MLHUB Partner Lifetime', 'mlhub-partner-lifetime', 2499, 3, false, false, false, 0, 42, 'High-capacity MLHUB operations for partners managing many businesses and customers.', $this->partnerPermissions(20000)),
        ];
    }
