...
@php
    ...
    $darkAccent = theme_setting('dark_accent_color', 'app', '#ff8a8a');
    ...
    $darkHeaderActive = theme_setting('dark_header_active_color', 'app', '#ffb347');
    $darkHeaderActiveRgb = theme_color_rgb('dark_header_active_color', 'app', '#ffb347');
