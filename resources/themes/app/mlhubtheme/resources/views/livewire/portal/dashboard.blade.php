...
>
            ...
            <div>
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    @if ($onboardingComplete)
                        <span class="inline-flex items-center gap-2 rounded-full border px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em]" style="border-color: rgba(var(--theme-success-color-rgb),0.25); background: rgba(var(--theme-success-color-rgb),0.09); color: var(--theme-success-color);">
    ...
    <section class="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
        @foreach ([
            ['label' => __('Businesses'), 'value' => $growthMetrics['businesses'] ?? 0, 'description' => __('Local profiles'), 'icon' => 'fa-light fa-store', 'tone' => 'accent'],
            ['label' => __('Active Campaigns'), 'value' => $growthMetrics['active_campaigns'] ?? 0, 'description' => __('Published funnels'), 'icon' => 'fa-light fa-bullhorn', 'tone' => 'accent'],
            ['label' => __('Visits'), 'value' => $growthMetrics['visits'] ?? 0, 'description' => __('Tracked page views'), 'icon' => 'fa-light fa-eye', 'tone' => 'accent'],
            ['label' => __('Review Clicks'), 'value' => $growthMetrics['review_clicks'] ?? 0, 'description' => __('Public review actions'), 'icon' => 'fa-light fa-star', 'tone' => 'warning'],
            ['label' => __('Conversion Rate'), 'value' => ($growthMetrics['conversion_rate'] ?? 0).'%', 'description' => __('Conversions / visits'), 'icon' => 'fa-light fa-chart-simple', 'tone' => 'accent'],
            ['label' => __('Leads'), 'value' => $growthMetrics['leads'] ?? 0, 'description' => __('Lead forms'), 'icon' => 'fa-light fa-user-plus', 'tone' => 'accent'],
            ['label' => __('Bookings'), 'value' => $growthMetrics['bookings'] ?? 0, 'description' => __('Appointment requests'), 'icon' => 'fa-light fa-calendar-check', 'tone' => 'accent'],
            ['label' => __('Coupon Claims'), 'value' => $growthMetrics['coupon_claims'] ?? 0, 'description' => __('Claimed offers'), 'icon' => 'fa-light fa-ticket', 'tone' => 'warning'],
            ['label' => __('Feedback'), 'value' => $growthMetrics['feedback'] ?? 0, 'description' => __('Private responses'), 'icon' => 'fa-light fa-message-lines', 'tone' => 'warning'],
            ['label' => __('Recent Activity'), 'value' => $recentActivity->count(), 'description' => __('Latest signals'), 'icon' => 'fa-light fa-clock-rotate-left', 'tone' => 'accent'],
        ] as $metric)
            @php
                $metricTone = ($metric['tone'] ?? 'accent') === 'warning' ? 'warning' : 'accent';
                $metricColor = $metricTone === 'warning' ? 'var(--theme-warning-color)' : 'var(--theme-accent)';
                $metricRgb = $metricTone === 'warning' ? 'var(--theme-warning-color-rgb)' : 'var(--theme-accent-rgb)';
            @endphp
            <article class="rounded-[1rem] border bg-white p-4 shadow-sm" style="border-color: rgba(var(--theme-border-color-rgb),0.72); border-top: 4px solid {{ $metricColor }};">
                <div class="flex items-start justify-between gap-4">
                    ...
                    <span class="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl" style="background-color: rgba({{ $metricRgb }}, 0.1); color: {{ $metricColor }};">
