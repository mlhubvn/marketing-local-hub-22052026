@php
    ...
    $companyName = trim((string) $options->get('contact_company_name', config('app.name', 'MLHUB')));
    ...
    <style>
        ...
        .lb-contact-panel {
            background:
                ...
                radial-gradient(circle at 86% 86%, rgba(255, 140, 66, .2), transparent 18rem),
                rgba(255, 255, 252, .94);
        }
        ...
        html[data-theme-resolved='dark'] .lb-contact-row {
            border-color: rgba(255, 140, 66, .14) !important;
        }
    </style>
        ...
        <section class="lb-wrap lb-contact-hero pb-20 pt-16 lg:pt-20">
            <div class="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
                <div class="lb-reveal">
                    ...
                    <h1 class="lb-serif lb-hero-title mt-7">{{ __('Talk to MLHUB') }}</h1>
