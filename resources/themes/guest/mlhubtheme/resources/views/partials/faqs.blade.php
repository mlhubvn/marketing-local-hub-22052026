            ...
            <div class="lg:sticky lg:top-28">
                ...
                <div class="grid gap-4 sm:grid-cols-2 mb-6">
                    <div class="rounded-3xl border border-white bg-white/90 px-6 py-5 shadow-sm">
                        <p class="text-sm uppercase tracking-widest text-[#ff5f5f] font-semibold mb-2" style="letter-spacing:0.18em;">{{ __("Coverage") }}</p>
                    ...
                    <div class="rounded-3xl border border-white bg-white/90 px-6 py-5 shadow-sm">
                        <p class="text-sm uppercase tracking-widest text-[#ff5f5f] font-semibold mb-2" style="letter-spacing:0.18em;">{{ __("Support") }}</p>
                ...
                <div class="p-7 bg-white rounded-[2rem] border border-[#ffe5dc] shadow-[0_20px_60px_rgba(255,95,95,0.08)]">
                    <div class="flex items-start justify-between gap-4">
                        <div>
                            <p class="text-sm uppercase tracking-widest text-[#ff5f5f] font-semibold mb-3" style="letter-spacing:0.22em;">{{ __("Still need help?") }}</p>
                            ...
                            <a class="inline-flex items-center text-[#ff5f5f] hover:text-[#e84a3a] font-semibold" href="{{ url('contact') }}">
                                {{ __("Contact us") }}
                                <i class="fa-solid fa-arrow-right ml-2 text-sm"></i>
                            </a>
                        </div>
                        <span class="hidden sm:inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-[#fff0eb] text-[#ff5f5f] flex-shrink-0">
                        ...
                        >
                            <div class="flex items-start justify-between gap-6">
                                ...
                                <span class="inline-flex items-center justify-center w-11 h-11 rounded-2xl flex-shrink-0"
                                      :class="open === {{ $faq->id }} ? 'bg-[#ff5f5f] text-white' : 'bg-[#fff0eb] text-[#ff5f5f]'">
