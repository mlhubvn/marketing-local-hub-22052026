            ...
            <div class="grid gap-12 lg:grid-cols-[minmax(0,0.9fr)_minmax(34rem,1.1fr)] lg:items-center">
                <div>
                    ...
                    <p class="lb-reveal mt-5 max-w-xl text-base leading-8" style="--lb-delay: 210ms; color: var(--lb-muted);">
                        {{ __('MKT AI helps restaurants, salons, clinics, gyms and local shops publish campaign pages, collect customers, generate AI copy, share QR codes and track real growth from one dashboard.') }}
                    </p>
            ...
            <div class="lb-card lb-proof-panel rounded-3xl p-6 sm:p-8">
                <div class="grid gap-10 lg:grid-cols-[0.86fr_1.14fr] lg:items-center">
                    <div class="relative z-10">
                        ...
                        <p class="mt-5 text-base leading-8" style="color: var(--lb-muted);">{{ __('MKT AI turns a local marketing goal into a public campaign page, a QR code, customer capture, AI content and measurable reports in one connected workflow.') }}</p>
            ...
            <div class="lb-window lb-final-cta rounded-3xl p-6 sm:p-8">
                <div class="grid gap-8 lg:grid-cols-[1fr_24rem] lg:items-center">
                    <div>
                        ...
                        <p class="mt-5 max-w-2xl text-base leading-8" style="color: var(--lb-muted);">{{ __('Create campaign pages for reviews, bookings, coupons, leads and feedback, then share them with public links and QR codes while MKT AI tracks every result.') }}</p>
