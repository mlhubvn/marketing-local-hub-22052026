@component(theme_view('layouts.marketing', 'guest'), ['pageTitle' => $pageTitle])
    ...
    <article class="localboost-shell localboost-section pt-10" itemscope itemtype="https://schema.org/BlogPosting">
        <div class="mx-auto max-w-5xl">
            ...
            <div class="mt-10 grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_18rem]">
                <div class="min-w-0 localboost-card rounded-[1.5rem] p-6 sm:p-8">
