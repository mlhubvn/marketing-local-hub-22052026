...
>
    <div class="localboost-cookie-banner mx-auto max-w-5xl rounded-[1.1rem] border p-4 shadow-[0_24px_80px_-56px_rgba(15,23,42,0.45)] backdrop-blur-xl sm:p-5" style="border-color: #dfe9df; background: linear-gradient(135deg, rgba(15,118,110,0.055), rgba(255,255,255,0.96) 42%, rgba(247,250,246,0.98));">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div class="flex min-w-0 gap-3">
                <span class="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[0.85rem]" style="background-color: rgba(15,118,110,0.10); color: #0f766e;">
                ...
                <div class="min-w-0">
                    ...
                    <p class="mt-1 max-w-3xl text-sm leading-6" style="color: var(--theme-muted-text-color);">
                        ...
                        <a href="{{ route('guest.privacy-policy') }}" class="font-bold hover:opacity-80" style="color: #0f766e;">{{ __('Read our cookie policy') }}</a>
                    </p>
                </div>
            </div>
