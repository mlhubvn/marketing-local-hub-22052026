            ...
            <div class="lb-card lb-blog-topic-panel lb-reveal mt-6 rounded-2xl p-5 sm:p-6" style="--lb-delay: 140ms;">
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <div class="min-w-0">
                        ...
                        <h3 class="lb-serif lb-subheading mt-1.5 text-xl sm:text-2xl">{{ __('Learn the workflows that move local growth') }}</h3>
                    </div>
                    <span class="shrink-0 rounded-full px-3 py-1 text-xs font-black" style="background: color-mix(in srgb, var(--lb-lime) 30%, #fff); color:#ff5f5f;">{{ $blogs->total() }} {{ __('posts') }}</span>
                </div>
