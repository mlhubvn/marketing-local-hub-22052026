...
<style>
    ...
    html[data-theme-resolved='dark'] {
        ...
        --theme-link-hover-color: {{ theme_setting('link_hover_color', 'guest', '#ff8c42') }};
        ...
        --theme-warning-color: {{ theme_setting('warning_color', 'guest', '#ffb347') }};
    ...
    body {
        ...
        background:
            ...
            linear-gradient(180deg, #fffbf8 0%, #fff5f0 42%, #ffe5dc 100%);
    ...
    .mlhub-hero-stage {
        ...
        background:
            linear-gradient(135deg, rgba(255,95,95,0.11) 0%, rgba(255,255,255,0.88) 34%, rgba(20,184,166,0.12) 68%, rgba(245,158,11,0.14) 100%),
    ...
    .mlhub-hero-stage::after {
        ...
        z-index: -1;
        height: 34%;
        background: linear-gradient(90deg, rgba(255,95,95,0.12), rgba(20,184,166,0.12), rgba(245,158,11,0.10));
    ...
    .mlhub-visual {
        ...
        isolation: isolate;
        background:
            linear-gradient(135deg, rgba(255,95,95,0.10), rgba(20,184,166,0.10)),
    ...
    .mlhub-auth-primary {
        ...
        background:
            linear-gradient(135deg, #ff5f5f 0%, #ff8c42 48%, #ffb347 100%);
        color: #ffffff;
        box-shadow:
    ...
    .lb-rich-content blockquote {
        margin: 1.5em 0;
        border-left: 3px solid var(--lb-red, #ff5f5f);
