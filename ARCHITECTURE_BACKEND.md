...
| `modules/CustomMLHUB/`                                                                                               | Gói thị trường VN: `mlhub:install` (cài sạch DB), `mlhub:update` (migrate + seed giữ dữ liệu), super admin từ env, `mlhub_site_options.php`, script Việt hóa AI templates, `STARTING_ID=147123468`.                                                                                                                                                                |
